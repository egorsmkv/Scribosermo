...
def detect_silence(sound: AudioSegment, silence_threshold=-50.0, chunk_size=10) -> (int, int):
    start_trim = 0  # ms
...
def trim_silence_audio(sound: AudioSegment, silence_threshold=-50.0, chunk_size=10) -> AudioSegment:
...
def convert(filename: str, dst_dirpath: str, dirpath: str, normalize: bool, trim_silence: bool,
            min_duration_seconds: float, max_duration_seconds: float):
...
if __name__ == "__main__":
    ...
    print("Your noise dataset has {} files and a duration of {} hours\n".format(file_num, seconds_to_hours(duration)))
